...
#预训练模型
model_ft = initialize_model('vgg16', classnum, feature_extract=True, use_pretrained=True)
...
#无训练模型
model = initialize_model('vgg16', classnum, feature_extract=False, use_pretrained=False)
...
torch.save(model_ft.state_dict(), 'vgg_ft.pth')
