# -*- coding: utf-8 -*-
"""
Created on Mon May  4 03:49:47 2020
...
#预训练模型
model_ft = initialize_model('bagnet', classnum, feature_extract=True, use_pretrained=True)
...
#无训练模型
model = initialize_model('bagnet', classnum, feature_extract=False, use_pretrained=False)
...
torch.save(model.state_dict(), 'bag33.pth')
...
torch.save(model_ft.state_dict(), 'bag_ft33.pth')
